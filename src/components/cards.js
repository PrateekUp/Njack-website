    ...
    <div className={styles['GrowingCompanySection']}>
      ...
      <div className={styles['container']}>
        <div className={styles['container1']}>
          <svg viewBox="0 0 967.4605714285714 1024" className={styles['icon']}>
...
Cards.defaultProps = {
  ...
  image_alt: 'image',
  text1: 'Carefully crafted components',
  text3: 'Dynamic components',
  text: "The extension comes with three pre-build pages to help you get started faster. You can change the text and images and you're good to go.",
  heading: 'EVENT 1',
}
