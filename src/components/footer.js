...
const Footer = () => {
  return (
    <div className={styles['container']}>
      <div className={styles['container01']}>
        <div className={styles['container02']}>
          ...
          <span className={styles['text02']}>
            <span>Find out on any of these platforms, we r</span>
            <span>&amp;#8203;</span>
            <span>espond 1-2 business days.</span>
          </span>
        ...
        <div className={styles['container08']}>
          ...
          <div className={styles['container10']}>
            <span
              className={` ${styles['text11']} ${projectStyles['textXS']} `}
            >
              OTHER RESOURCES
            </span>
            <span
            ...
            <span
              className={` ${styles['text13']} ${projectStyles['textSM']} `}
            >
              Terms &amp; Conditions
            </span>
            <span
              className={` ${styles['text14']} ${projectStyles['textSM']} `}
            >
              Privacy Policy
            </span>
            <span
              className={` ${styles['text15']} ${projectStyles['textSM']} `}
            >
              Contact Us
            </span>
          </div>
      ...
      <span className={` ${styles['text16']} ${projectStyles['textSM']} `}>
