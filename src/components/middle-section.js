  ...
  return (
    <div className={styles['container']}>
      ...
      <div className={styles['container02']}>
        <h1 className={styles['text01']}>{props.heading3}</h1>
      </div>
      <div className={styles['CardsContainer1']}>
        <div className={styles['Card1']}>
          ...
          <h6 className={` ${styles['text02']} ${projectStyles['textXL']} `}>
            {props.heading8}
          </h6>
          <span className={styles['text03']}>{props.text3}</span>
        </div>
        <div className={styles['Card2']}>
          ...
          <h6 className={` ${styles['text04']} ${projectStyles['textXL']} `}>
            {props.heading9}
          </h6>
        ...
        <div className={styles['Card3']}>
          ...
          <h6 className={` ${styles['text06']} ${projectStyles['textXL']} `}>
            {props.heading10}
          </h6>
          <span className={styles['text07']}>{props.text5}</span>
        </div>
      </div>
      <div className={styles['container06']}>
        <h1 className={styles['text08']}>{props.heading4}</h1>
      </div>
      <div className={styles['CardsContainer2']}>
        <div className={styles['Card11']}>
          ...
          <h6 className={` ${styles['text09']} ${projectStyles['textXL']} `}>
            {props.heading11}
          </h6>
          <span className={styles['text10']}>{props.text6}</span>
        </div>
        <div className={styles['Card21']}>
          ...
          <h6 className={` ${styles['text11']} ${projectStyles['textXL']} `}>
            {props.heading12}
          </h6>
          <span className={styles['text12']}>{props.text7}</span>
        </div>
        <div className={styles['Card31']}>
          ...
          <h6 className={` ${styles['text13']} ${projectStyles['textXL']} `}>
            {props.heading13}
          </h6>
...
MiddleSection.defaultProps = {
  ...
  heading11: 'Awarded Agency',
  heading8: 'Awarded Agency',
  text4:
    'Keep you user engaged by providing meaningful information. Remember that by this time, the user is curious.\n\n',
  text7:
    'Keep you user engaged by providing meaningful information. Remember that by this time, the user is curious.\n\n',
  heading10: 'Verified Company',
  text5:
    'Write a few lines about each one. A paragraph describing a feature will be enough. Keep you user engaged!',
  heading9: 'Free Revisions',
  heading2: 'cyber security',
  heading4: 'CP',
  heading13: 'Verified Company',
  heading12: 'Free Revisions',
}
